...
RUN java -XX:AOTCacheOutput=app.aot -Dspring.profiles.active=h2 \
...
ENTRYPOINT ["java", "-XX:AOTCache=app.aot", "-Dspring.aot.enabled=true", "-Dspring.profiles.active=h2", "-jar", "application.jar"]